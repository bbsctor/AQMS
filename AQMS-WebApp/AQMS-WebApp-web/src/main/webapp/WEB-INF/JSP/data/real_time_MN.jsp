...
<div class="historydata" >
  ...
  <div class="panel"  >
   <form action="${pageContext.request.contextPath }/RealData/QueryByTimeAndMN" method="post">
...
<script type="text/javascript">
   ...
   var options=$("#MN option:selected"); //获取选中的项
     ...
     function change_num()
     {
        ...
        url='${pageContext.request.contextPath }/RealData/QueryByTimeAndMN?StartTime='+start+'&EndTime='+end+'&MN='+h_mn+'&num='+number; 
   ...
   function  first()
   {
      var options=$("#MN option:selected"); //获取选中的项
       ...
       var number=$("#number").val();
        ...
        {
           alert("请选择对应时间段");
           url='${pageContext.request.contextPath }/RealData/QueryByTimeAndMNInit?MN='+h_mn+'&num='+number;
        }           
        else
           url='${pageContext.request.contextPath }/RealData/QueryByTimeAndMN?page='+"1"+'&StartTime='+start+'&EndTime='+end+'&MN='+h_mn+'&num='+number; 
       window.location.href=url;   
   }
    function  next()
   {
      ...
      var start=document.getElementById("start").value;
       ...
       var in_next=$("#in_next").val();  
        ...
        if(start=="" || end=="")
        {
           ...
           url='${pageContext.request.contextPath }/RealData/QueryByTimeAndMN?page='+in_next+'&StartTime='+start+'&EndTime='+end+'&MN='+h_mn+'&num='+number; 
       window.location.href=url;    
   }
      ...
      var start=document.getElementById("start").value;
       ...
       var in_pre=$("#in_pre").val();
        ...
        if(start=="" || end=="")
        {
           ...
           url='${pageContext.request.contextPath }/RealData/QueryByTimeAndMN?page='+in_pre+'&StartTime='+start+'&EndTime='+end+'&MN='+h_mn+'&num='+number; 
       window.location.href=url;    
   }
      ...
      // var in_last=$("#in_last").val();
       ...
       var in_total=$("#in_total").val();  
        ...
        if(start=="" || end=="")
        {
         ...
         url='${pageContext.request.contextPath }/RealData/QueryByTimeAndMN?page='+in_last+'&StartTime='+start+'&EndTime='+end+'&MN='+h_mn+'&num='+number; 
       window.location.href=url;     
   }
   ...
   function exportTimeAndMN()
   {
       ...
       var url;
        ...
        {
           alert("请选择对应时间段");
           url='${pageContext.request.contextPath }/RealData/QueryByTimeAndMNInit';
        }        
        else
         url='${pageContext.request.contextPath }/RealData/exportTimeAndMN?StartTime='+start+'&EndTime='+end+'&MN='+h_mn; 
        window.location.href=url;    
   }
</script>
</body>
