 ...
 */
public class UsernamePasswordUsertypeToken implements HostAuthenticationToken,
	 ...
	 *            用户类型
	 */
	public UsernamePasswordUsertypeToken(final String username,
