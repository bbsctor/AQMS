...
.demo1{float:left; margin:10px 10px 10px 400px; }
.demo4,.demo2{float:left; margin:10px; }
.demo3{float:right; margin:10px; }
</style>
...
<div class="historydata" >
  ...
  <div class="panel"  >
   <form action="${pageContext.request.contextPath }/HistoryData/QueryByTimeAndMN" method="post">
   <div class="demo1" style="float:left; ">
    ...
    <div class="demo4" >
   			<input type="submit" style=" width:50px; height:25px;" value="查询" />
	</div>
  </form>
  <div class="demo3">			   
         <input  type="button" value="导出数据" style="width:80px;height:25x" onclick="exportTimeAndMN()"/>
   </div>
 </div>
...
<script type="text/javascript">
   ...
   var options=$("#MN option:selected"); //获取选中的项
      ...
      function change_num()
     {
        ...
        var url;
        url='${pageContext.request.contextPath }/HistoryData/QueryByTimeAndMN?StartTime='+start+'&EndTime='+end+'&MN='+h_mn+'&num='+number; 
   ...
   function  first()
   {
      ...
      //  var in_first=$("#in_first").val();
        ...
        {
           alert("请选择对应时间段");
           url='${pageContext.request.contextPath }/HistoryData/QueryByTimeAndMNInit';
        }
           
        else
           url='${pageContext.request.contextPath }/HistoryData/QueryByTimeAndMN?page='+"1"+'&StartTime='+start+'&EndTime='+end+'&MN='+h_mn+'&num='+number; 
       window.location.href=url;     
   }
    function  next()
   {
      ...
      var start=document.getElementById("start").value;
       ...
       var number=$("#number").val();
        ...
        {
           alert("请选择对应时间段");
           url='${pageContext.request.contextPath }/HistoryData/QueryByTimeAndMNInit?MN='+h_mn;
        }        
        else
           url='${pageContext.request.contextPath }/HistoryData/QueryByTimeAndMN?page='+in_next+'&StartTime='+start+'&EndTime='+end+'&MN='+h_mn+'&num='+number; 
       window.location.href=url;    
   }
      ...
      var start=document.getElementById("start").value;
       ...
       var number=$("#number").val();
        ...
        if(start=="" || end=="")
        {
           ...
           url='${pageContext.request.contextPath }/HistoryData/QueryByTimeAndMN?page='+in_pre+'&StartTime='+start+'&EndTime='+end+'&MN='+h_mn+'&num='+number;  
       window.location.href=url;    
   }
    ...
    var options=$("#MN option:selected"); //获取选中的项
       ...
       var in_total=$("#in_total").val();  
        ...
        if(start=="" || end=="")
        {
         ...
         url='${pageContext.request.contextPath }/HistoryData/QueryByTimeAndMN?page='+in_last+'&StartTime='+start+'&EndTime='+end+'&MN='+h_mn+'&num='+number;  
       window.location.href=url;     
   }
   
   function exportTimeAndMN()
   {
       var options=$("#MN option:selected"); //获取选中的项
       document.getElementById("h_mn").value =options.val();
       var h_mn=$(" #h_mn ").val();
       ...
       var url;
        ...
        {
           alert("请选择对应时间段");
           url='${pageContext.request.contextPath }/HistoryData/QueryByTimeAndMNInit?MN='+h_mn+'&num='+number; 
        }        
        else
         url='${pageContext.request.contextPath }/HistoryData/exportTimeAndMN?StartTime='+start+'&EndTime='+end+'&MN='+h_mn+'&num='+number; 
        window.location.href=url;    
   }
</script>
</body>
