...
<div class="historydata" >
  ...
  <div class="panel"  >
   <form action="${pageContext.request.contextPath }/HistoryData/HistoryDataByTime" method="post">
  ...
  function change_num()
     {
       ...
       var url='${pageContext.request.contextPath }/HistoryData/HistoryDataByTime?StartTime='+start+'&EndTime='+end+'&num='+number;   
   ...
   function  first()
   {
      ...
      // var in_first=$("#in_first").val();
        var number=$("#number").val();
       var url='${pageContext.request.contextPath }/HistoryData/HistoryDataByTime?page='+"1"+'&StartTime='+start+'&EndTime='+end+'&num='+number; 
       window.location.href=url;   
   }
    function  next()
   {
      var start=document.getElementById("start").value;
       ...
       var number=$("#number").val();
       var url='${pageContext.request.contextPath }/HistoryData/HistoryDataByTime?page='+in_next+'&StartTime='+start+'&EndTime='+end+'&num='+number;  
    ...
    function  pre()
   {
      var start=document.getElementById("start").value;
       ...
       var in_pre=$("#in_pre").val();
        var number=$("#number").val();
       var url='${pageContext.request.contextPath }/HistoryData/HistoryDataByTime?page='+in_pre+'&StartTime='+start+'&EndTime='+end+'&num='+number; 
      window.location.href=url;   
   }
    ...
    function  last()
   {
       ...
       var url='${pageContext.request.contextPath }/HistoryData/HistoryDataByTime?page='+in_last+'&StartTime='+start+'&EndTime='+end+'&num='+number;  
      window.location.href=url;   
   }
</script>
</body>
